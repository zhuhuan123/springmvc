...
$(function() {  
    ...
    function onSelect(note)
    {
    	...
    	if(note.data.resourceType==2 || note.data.resourceType==0){
    		...
    		tab.addTabItem({url:note.data.url,text:note.data.text,tabid:"tab"+note.data.id})
    	}
    }
    $("#tree1").ligerTree({  
        url:'trees', 
...
<div id="container">  
        ...
        <div position="center" id="center"> 
        	<!-- <div title="t1" id="ta1" showClose="true">内容1</div> 
        	<div title="t2" id="ta2" showClose="true">内容2</div>  -->
        </div>  
